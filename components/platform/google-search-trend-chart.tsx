...
export function GoogleSearchTrendChart({ dateFilter = 'all' }: GoogleSearchTrendChartProps) {
  ...
  const fetchTrendData = async () => {
    ...
    try {
      ...
      console.error('Failed to fetch Google Search trend data:', error)
      setData([])
    } finally {
      setIsLoading(false)
    }
  ...
  if (isLoading) {
    return (
      <Card>
        <CardHeader>
          <CardTitle>Anduin GG Search Appearance Over Time</CardTitle>
        </CardHeader>
        <CardContent>
